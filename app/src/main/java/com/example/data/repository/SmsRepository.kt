...
import com.example.data.analytics.AnomalyItem
import com.example.data.analytics.CategorySlice
import com.example.data.analytics.FinanceAnalyticsEngine
import com.example.data.analytics.MonthEndForecast
import com.example.data.analytics.RecurringItem
...
import com.example.data.parser.SenderMatcher
...
class SmsRepository(private val context: Context) {
    ...
    suspend fun processSingleSms(
        ...
        val customParserRules = parserRuleDao.getActiveRulesList()
        ...
        val parseResult = parserEngine.parseMessage(
            ...
            customParserRules = customParserRules
        )
